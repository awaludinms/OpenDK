...
<section class="content container-fluid">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Form::model($kategori_lembaga, ['route' => ['setting.kategori_lembaga.update', $kategori_lembaga->id], 'method' => 'put', 'id' => 'form-lembaga', 'class' => 'form-horizontal form-label-left']) !!}
            @csrf
            <div class="row">
                <div class="col-md-12">
                    @if (count($errors) > 0)
